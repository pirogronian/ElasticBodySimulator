#############################################################################
# Makefile for building: ElasticBodySimulator
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  Elastic Body Simulator.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile Elastic\ Body\ Simulator.pro
#############################################################################
...
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -I. -I. -ISimulator/v1.0 -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -Imoc
LINK          = g++
...
SOURCES       = main.cpp \
		...
		Presenter.cpp \
		Simulator/v1.0/ElasticBodySimulator.cpp moc/moc_MainWindow.cpp \
		moc/moc_NewSimulationDialog.cpp \
		moc/moc_Presenter.cpp \
		moc/moc_ElasticBodySimulator.cpp
OBJECTS       = obj/main.o \
		obj/MainWindow.o \
		obj/NewSimulationDialog.o \
		obj/Presenter.o \
		obj/ElasticBodySimulator.o \
		obj/moc_MainWindow.o \
		obj/moc_NewSimulationDialog.o \
		obj/moc_Presenter.o \
		obj/moc_ElasticBodySimulator.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Elastic Body Simulator.pro main.cpp \
		MainWindow.cpp \
		NewSimulationDialog.cpp \
		Presenter.cpp \
		Simulator/v1.0/ElasticBodySimulator.cpp
QMAKE_TARGET  = ElasticBodySimulator
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = ElasticBodySimulator
...
Makefile: Elastic\ Body\ Simulator.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		Elastic\ Body\ Simulator.pro \
		/usr/lib/libQt5Widgets.prl \
		/usr/lib/libQt5Gui.prl \
		/usr/lib/libQt5Core.prl
	$(QMAKE) -o Makefile Elastic\ Body\ Simulator.pro
...
dist: 
	@test -d obj/ElasticBodySimulator1.0.0 || mkdir -p obj/ElasticBodySimulator1.0.0
	$(COPY_FILE) --parents $(DIST) obj/ElasticBodySimulator1.0.0/ && $(COPY_FILE) --parents MainWindow.h NewSimulationDialog.h Presenter.h Simulator/v1.0/ElasticBodySimulator.h obj/ElasticBodySimulator1.0.0/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp NewSimulationDialog.cpp Presenter.cpp Simulator/v1.0/ElasticBodySimulator.cpp obj/ElasticBodySimulator1.0.0/ && (cd `dirname obj/ElasticBodySimulator1.0.0` && $(TAR) ElasticBodySimulator1.0.0.tar ElasticBodySimulator1.0.0 && $(COMPRESS) ElasticBodySimulator1.0.0.tar) && $(MOVE) `dirname obj/ElasticBodySimulator1.0.0`/ElasticBodySimulator1.0.0.tar.gz . && $(DEL_FILE) -r obj/ElasticBodySimulator1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc/moc_MainWindow.cpp moc/moc_NewSimulationDialog.cpp moc/moc_Presenter.cpp moc/moc_ElasticBodySimulator.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_MainWindow.cpp moc/moc_NewSimulationDialog.cpp moc/moc_Presenter.cpp moc/moc_ElasticBodySimulator.cpp
moc/moc_MainWindow.cpp: Simulator/v1.0/ElasticBodySimulator.h \
		Presenter.h \
		MainWindow.h
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator' -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator' -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator/Simulator/v1.0' -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/4.9.1 -I/usr/include/c++/4.9.1/x86_64-unknown-linux-gnu -I/usr/include/c++/4.9.1/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include-fixed -I/usr/include MainWindow.h -o moc/moc_MainWindow.cpp

moc/moc_NewSimulationDialog.cpp: NewSimulationDialog.h
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator' -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator' -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator/Simulator/v1.0' -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/4.9.1 -I/usr/include/c++/4.9.1/x86_64-unknown-linux-gnu -I/usr/include/c++/4.9.1/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include-fixed -I/usr/include NewSimulationDialog.h -o moc/moc_NewSimulationDialog.cpp

moc/moc_Presenter.cpp: Simulator/v1.0/ElasticBodySimulator.h \
		Presenter.h
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator' -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator' -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator/Simulator/v1.0' -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/4.9.1 -I/usr/include/c++/4.9.1/x86_64-unknown-linux-gnu -I/usr/include/c++/4.9.1/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include-fixed -I/usr/include Presenter.h -o moc/moc_Presenter.cpp

moc/moc_ElasticBodySimulator.cpp: Simulator/v1.0/ElasticBodySimulator.h
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator' -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator' -I'/mnt/pub/Program/c++/Qt/Elastic Body Simulator/Simulator/v1.0' -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/4.9.1 -I/usr/include/c++/4.9.1/x86_64-unknown-linux-gnu -I/usr/include/c++/4.9.1/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include-fixed -I/usr/include Simulator/v1.0/ElasticBodySimulator.h -o moc/moc_ElasticBodySimulator.cpp
...
obj/main.o: main.cpp MainWindow.h \
		Simulator/v1.0/ElasticBodySimulator.h \
		Presenter.h
...
obj/NewSimulationDialog.o: NewSimulationDialog.cpp NewSimulationDialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/NewSimulationDialog.o NewSimulationDialog.cpp

obj/Presenter.o: Presenter.cpp Presenter.h \
		Simulator/v1.0/ElasticBodySimulator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/Presenter.o Presenter.cpp

obj/ElasticBodySimulator.o: Simulator/v1.0/ElasticBodySimulator.cpp Simulator/v1.0/ElasticBodySimulator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/ElasticBodySimulator.o Simulator/v1.0/ElasticBodySimulator.cpp

obj/moc_MainWindow.o: moc/moc_MainWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/moc_MainWindow.o moc/moc_MainWindow.cpp

obj/moc_NewSimulationDialog.o: moc/moc_NewSimulationDialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/moc_NewSimulationDialog.o moc/moc_NewSimulationDialog.cpp

obj/moc_Presenter.o: moc/moc_Presenter.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/moc_Presenter.o moc/moc_Presenter.cpp

obj/moc_ElasticBodySimulator.o: moc/moc_ElasticBodySimulator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/moc_ElasticBodySimulator.o moc/moc_ElasticBodySimulator.cpp
